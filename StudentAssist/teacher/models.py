...
class Teacher(models.Model):
    ...
    def _str_(self):
        return self.user        #string representation is used so that the object that we have called helps to display the output
...
class Course(models.Model):
    ...
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE)      #course is linked to teacher, therefore FK
...
class Attendee(models.Model):                                       #for enrolling the students
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE)
